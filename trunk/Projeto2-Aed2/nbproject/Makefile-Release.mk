...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projeto2-aed2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projeto2-aed2: ${OBJECTFILES}
...
${OBJECTDIR}/Les.o: Les.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Les.o Les.cpp

${OBJECTDIR}/Elemento_Floresta.o: Elemento_Floresta.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Elemento_Floresta.o Elemento_Floresta.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projeto2-aed2
